            ...
            <div class="col-12">
                <div class="card mb-2">
                    <div class="card-header pb-0 d-flex justify-content-between">
                        <div>
                            <a href="{{ route('reports.custom') }}" class="btn btn-small btn-warning">Summary</a>
                            ...
                            <form action="{{ route('reports.custom') }}" method="GET">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mt-4">
                                        <a href="{{ route('reports.custom', ['start_date' => $startDate, 'end_date' => $endDate, 'pdf' => 1]) }}" class="btn btn-danger">Download PDF</a>
                                    </div>
                                </div>
                            </form>
                        </div>
